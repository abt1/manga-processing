...
outputfile.write("Subject ID, PLATE, IFUDSGN, Regular Rotation,Kinematically Distinct Core, Counter-Rotating Core,"
                 ...
                 "Misaligned, Regular Rotation,Kinematically Distinct Core, Counter-Rotating Core,Kinematic Twist,Double Peak,"
...
Columnslist = ['PLATE', 'IFUDSGN', 'Regular Rotation', 'Kinematically Distinct Core', 'Counter-Rotating Core',
               ...
               'Similar', 'Different', 'Misaligned', 'Regular RotationG', 'Kinematically Distinct CoreG', 'Counter-Rotating CoreG',
...
for row in inputfile:
    if row[5] == 'Main Sample':
        ...
        if answer2 == "Same features, but misaligned":
            featuredict['Misaligned'] += 1
            for a in answer1:
                if a != "Not enough data present/can't tell":
                    featuredict2[a + 'G'] += 1
                else:
